...
`)},e.material.needsUpdate=!0}),{uTime:r}}function kd(e,t){let n=Object.assign({freq:2.3,waveLen:4.2,ampRatio:.085,pivot:0,twist:0,lift:4871520,map:null},t),r={value:0},i={value:1};return e.traverse(e=>{if(!e.isMesh)return;e.geometry.computeBoundingBox();let t=e.geometry.boundingBox,a=t.min.z,o=Math.max(1e-5,t.max.z-t.min.z);e.material=e.material.clone(),n.map&&(e.material.map=n.map),e.material.map&&`emissive`in e.material&&(e.material.emissiveMap=e.material.map,e.material.emissive=new Y(n.lift)),e.material.onBeforeCompile=e=>{e.uniforms.uTime=r,e.uniforms.uAmpScale=i,e.uniforms.uMinZ={value:a},e.uniforms.uRangeZ={value:o},e.uniforms.uAmp={value:o*n.ampRatio},e.uniforms.uFreq={value:n.freq},e.uniforms.uWaveLen={value:n.waveLen},e.uniforms.uPivot={value:n.pivot},e.uniforms.uTwist={value:n.twist},e.vertexShader=e.vertexShader.replace(`#include <common>`,`#include <common>
uniform float uTime; uniform float uMinZ; uniform float uRangeZ; uniform float uAmp; uniform float uFreq; uniform float uWaveLen; uniform float uAmpScale; uniform float uPivot; uniform float uTwist;`).replace(`#include <begin_vertex>`,`#include <begin_vertex>
