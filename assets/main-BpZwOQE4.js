...
`)},e.material.needsUpdate=!0}),{uTime:r}}function Jd(e,t){let n=Object.assign({freq:1.6,ampRatio:.12,phaseK:1.2,power:2.5,lift:4871520,nightBoost:1.55},t),r={value:0};return e.traverse(e=>{if(!e.isMesh)return;e.geometry.computeBoundingBox();let t=e.geometry.boundingBox,i=t.min.z,a=Math.max(1e-5,t.max.z-t.min.z);e.material=e.material.clone(),e.material.map&&`emissive`in e.material&&(e.material.emissiveMap=e.material.map,e.material.emissive=new Y(n.lift),Kd.register(e.material,{base:1,boost:n.nightBoost})),e.material.onBeforeCompile=e=>{e.uniforms.uTime=r,e.uniforms.uMinZ={value:i},e.uniforms.uRangeZ={value:a},e.uniforms.uAmp={value:a*n.ampRatio},e.uniforms.uFreq={value:n.freq},e.uniforms.uPhaseK={value:n.phaseK},e.uniforms.uPow={value:n.power},e.vertexShader=e.vertexShader.replace(`#include <common>`,`#include <common>
...
`)},e.material.needsUpdate=!0}),{uTime:r}}function Yd(e,t){let n=Object.assign({freq:2.3,waveLen:4.2,ampRatio:.085,pivot:0,twist:0,lift:4871520,map:null,nightBoost:1.55},t),r={value:0},i={value:1},a={value:0};return e.traverse(e=>{if(!e.isMesh)return;e.geometry.computeBoundingBox();let t=e.geometry.boundingBox,o=t.min.z,s=Math.max(1e-5,t.max.z-t.min.z);e.material=e.material.clone(),n.map&&(e.material.map=n.map),e.material.map&&`emissive`in e.material&&(e.material.emissiveMap=e.material.map,e.material.emissive=new Y(n.lift),Kd.register(e.material,{base:1,boost:n.nightBoost})),e.material.onBeforeCompile=e=>{e.uniforms.uTime=r,e.uniforms.uAmpScale=i,e.uniforms.uBend=a,e.uniforms.uMinZ={value:o},e.uniforms.uRangeZ={value:s},e.uniforms.uAmp={value:s*n.ampRatio},e.uniforms.uFreq={value:n.freq},e.uniforms.uWaveLen={value:n.waveLen},e.uniforms.uPivot={value:n.pivot},e.uniforms.uTwist={value:n.twist},e.vertexShader=e.vertexShader.replace(`#include <common>`,`#include <common>
...
`)},e.material.needsUpdate=!0}),{uTime:r,uAmpScale:i,uBend:a}}var Xd=null;function Zd(){if(Xd)return Xd;let e=document.createElement(`canvas`);e.width=e.height=64;let t=e.getContext(`2d`),n=t.createRadialGradient(32,32,2,32,32,31);return n.addColorStop(0,`rgba(255,255,255,.9)`),n.addColorStop(.28,`rgba(255,255,255,.32)`),n.addColorStop(1,`rgba(255,255,255,0)`),t.fillStyle=n,t.fillRect(0,0,64,64),Xd=new va(e),Xd}function Qd(e,t,n=1){let r=new qr(new Nr({map:Zd(),color:e,transparent:!0,opacity:0,blending:2,depthWrite:!1}));return r.scale.setScalar(t),Kd.registerHalo(r,n),r}var $d=[[15968447,14250895],[11069656,5227425],[13220080,9400281]].map(([e,t])=>new Ba({color:e,emissive:t,emissiveIntensity:.3})),ef=.5,tf=0;function nf(){let e=.12+.4*ef+tf*(1.15+.6*ef);$d.forEach(t=>{t.emissiveIntensity=e})}nf();var rf={mats:$d,setVitality(e){ef=e,nf()},setNight(e){tf=e,nf()}},af=null;function of(){return af??=new Promise((e,t)=>{new zu().load(`/models/meshy-pillar.glb`,t=>{let n=t.scene;n.traverse(e=>{e.isMesh&&(e.geometry.computeVertexNormals(),e.material=new Ba({map:e.material.map??null,side:2}))}),n.updateMatrixWorld(!0),e({proto:n,size:new X().setFromObject(n).getSize(new W)})},void 0,t)}),af}function sf(e,t,{h:n,spread:r=1,topAlign:i=!1}){e.updateWorldMatrix(!0,!0);let a=new ss,o=n*(1+r);return(r,s)=>{let c=(i?s-1:s)*n,l=e.localToWorld(new W(Math.cos(r)*o,c,Math.sin(r)*o)),u=e.localToWorld(new W(0,c,0)).sub(l).normalize();a.set(l,u);let d=a.intersectObject(t,!0)[0];return d?e.worldToLocal(d.point.clone()):null}}function cf(e,t){e.updateWorldMatrix(!0,!0);let n=new ss;return(r,i)=>{let a=e.localToWorld(new W(r,8,i)),o=e.localToWorld(new W(r,-40,i)).sub(a).normalize();n.set(a,o);let s=n.intersectObject(t,!0)[0];return s?e.worldToLocal(s.point.clone()):new W(r,-.3,i)}}function lf(e={}){let{h:t=10,spread:n=1,yaw:r=0,tiltX:i=0,tiltZ:a=0,tint:o=1,glowCount:s=0,topAlign:c=!1,onModel:l=null}=e,u=new J;return of().then(({proto:e,size:d})=>{let f=e.clone(!0);o!==1&&f.traverse(e=>{e.isMesh&&(e.material=e.material.clone(),e.material.color.setScalar(o))});let p=t/d.y;f.scale.set(p*n,p,p*n),f.rotation.set(i,r,a),f.updateMatrixWorld(!0);let m=new X().setFromObject(f),h=m.getCenter(new W);if(f.position.set(-h.x,c?-m.max.y:-m.min.y,-h.z),u.add(f),s>0){let e=sf(u,f,{h:t,spread:n,topAlign:c}),r=[16234701,11071708,13679863];for(let t=0;t<s;t++){let n=e(t*2.39996,.04+.72*(t*.618%1)**1.35);if(!n)continue;let i=.26+t%3*.13,a=new hi(new Da(i,7,6),$d[t%3]);a.position.copy(n),u.add(a);let o=Qd(r[t%3],i*5.2,.75);o.position.copy(n),u.add(o)}}l?.(f,u)}),u}var uf=[{x:0,z:-2,y:-26,h:17,spread:2,yaw:2.6,tint:.94,glowCount:10},{x:10.2,z:6.4,y:-16.5,h:6.8,spread:1.5,yaw:.8,tint:1,glowCount:5},{x:19,z:9.6,y:-16.2,h:6.2,spread:1.45,yaw:3.8,tint:.97,glowCount:4},{x:-7.5,z:12,y:-17,h:7.5,spread:1.2,yaw:1.9,tiltZ:.07,tint:.95,glowCount:5},{x:-17,z:-12,y:-19,h:13,spread:1.05,yaw:4.4,tiltX:.06,tint:.92,glowCount:7},{x:20.5,z:-13,y:-18,h:10.5,spread:1.1,yaw:1.2,tiltZ:-.08,tint:.9,glowCount:6},{x:-26,z:2,y:-18,h:9,spread:1.3,yaw:5.3,tint:.9,glowCount:5},{x:27,z:5,y:-18,h:8,spread:1.35,yaw:2.9,tiltX:-.05,tint:.88,glowCount:4},{x:6,z:16,y:-16,h:6.5,spread:1.25,yaw:.3,tint:.93,glowCount:4},{x:-50,z:-58,y:-34,h:30,spread:2.4,yaw:.6,tint:.78,glowCount:4},{x:42,z:-64,y:-36,h:36,spread:2.1,yaw:3.4,tint:.75,glowCount:4},{x:-8,z:-76,y:-30,h:24,spread:2.8,yaw:1.7,tint:.72,glowCount:3},{x:-34,z:48,y:-33,h:28,spread:2.3,yaw:2.2,tint:.76,glowCount:4},{x:30,z:56,y:-35,h:32,spread:2,yaw:5,tint:.74,glowCount:4}];function df(){let e=new J;for(let t of uf){let n=lf(t);n.position.set(t.x,t.y,t.z),e.add(n)}return e.userData.setNight=e=>rf.setNight(e),e.userData.setVitality=e=>rf.setVitality(e),e}var ff=t;function pf(e,t){let n=new J,r=Vd({h:e*.3,w:e*.16,lean:1.05,color:t,emissive:1053720}),i=Vd({h:e*.25,w:e*.13,lean:1,flip:!0,color:t,emissive:1053720});return n.add(r,i),n}var mf={whaleShark(e){let t=(e.length??16)*.94,n=new J,r=null,i=null,a=null;new zu().load(`/models/meshy-whale-shark.glb`,e=>{let o=e.scene;o.updateMatrixWorld(!0);let s=new X().setFromObject(o).getSize(new W);o.scale.setScalar(t/Math.max(s.x,s.y,s.z)),o.traverse(e=>{e.isMesh&&(e.geometry.computeVertexNormals(),e.material=new Ba({map:e.material.map??null,side:2}),e.frustumCulled=!1)});let c=Yd(o,{freq:1.7,waveLen:3.8,ampRatio:.075,pivot:.09,twist:.11,nightBoost:.9});o.rotation.y=Math.PI/2,o.updateMatrixWorld(!0);let l=new X().setFromObject(o).getCenter(new W);o.position.sub(l),n.add(o),r=c.uTime,i=c.uAmpScale,a=c.uBend});let o=1;return n.userData.animate=(e,t,n)=>{r&&(r.value+=e*n*o)},n.userData.setSwimDrive=(e,t)=>{o=e,i&&(i.value=t)},n.userData.setSwimBend=e=>{a&&(a.value=e)},n},manta(e){let t=e.span??10,n=new J,r=null;new zu().load(`/models/meshy-manta.glb`,e=>{let i=e.scene;i.updateMatrixWorld(!0);let a=new X().setFromObject(i).getSize(new W);i.scale.setScalar(t/a.x),i.traverse(e=>{e.isMesh&&(e.geometry.computeVertexNormals(),e.material=new Ba({map:e.material.map??null,side:2}),e.frustumCulled=!1)});let o=qd(i,{freq:.82,ampRatio:.46,phaseK:1.9,nightBoost:1.1});i.rotation.y=Math.PI/2,i.updateMatrixWorld(!0);let s=new X().setFromObject(i).getCenter(new W);i.position.sub(s),n.add(i),r=o.uTime});let i=1;return n.userData.animate=(e,t,n)=>{r&&(r.value+=e*n*i)},n.userData.setSwimDrive=e=>{i=e},n},clownFamily(e){let t=new J;t.userData.selfDriven=!0;let n=new J,r=new hi(new Da(1.7,16,12),new Ba({color:11034490}));r.scale.y=.5,n.add(r);let i=[14250895,15173285,15968447].map(e=>new Ba({color:e})),a=[];for(let e=0;e<64;e++){let t=new J,r=e*2.39996,o=.12+.85*Math.sqrt(e/64);t.rotation.set(Math.cos(r)*o,0,Math.sin(r)*o);let s=2.2+Math.random()*.9,c=new hi(new Ca(.075,.12,s,5),i[e%3]);c.position.y=s/2+.4,t.add(c);let l=new hi(new Da(.11,6,5),i[(e+1)%3]);l.position.y=s+.4,t.add(l),t.userData.ph=Math.random()*7,t.userData.tiltA=r,t.userData.tiltR=o,n.add(t),a.push(t)}t.add(n);let o=e.count??3,s=[],c=[];for(let e=0;e<o;e++){let n=new J;n.userData.ph=e*2.1,n.userData.r=2.4+e*.7,n.scale.setScalar(1-e*.09),t.add(n),s.push(n)}return new zu().load(`/models/meshy-clownfish.glb`,e=>{let t=e.scene;t.updateMatrixWorld(!0);let n=new X().setFromObject(t).getSize(new W);t.scale.setScalar(1.5/Math.max(n.x,n.y,n.z)),t.traverse(e=>{e.isMesh&&(e.geometry.computeVertexNormals(),e.material=new Ba({map:e.material.map??null,side:2}),e.frustumCulled=!1)}),t.rotation.y=Math.PI/2,t.updateMatrixWorld(!0);let r=new X().setFromObject(t).getCenter(new W);t.position.sub(r),s.forEach((e,n)=>{let r=t.clone(!0),i=Yd(r,{freq:3.2,waveLen:5.2,ampRatio:.11,pivot:.1,twist:.14});i.uTime.value=n*1.7,c.push(i.uTime),e.add(r)})}),t.userData.animate=(e,t,n)=>{a.forEach(e=>{let r=Math.sin(t*1.3*n+e.userData.ph)*.16;e.rotation.x=Math.cos(e.userData.tiltA)*e.userData.tiltR+r,e.rotation.z=Math.sin(e.userData.tiltA)*e.userData.tiltR+r*.6}),s.forEach((e,r)=>{let i=e.userData.ph+t*.55*n*(1+r*.15),a=Math.cos(i)*e.userData.r,o=Math.sin(i)*e.userData.r*.7,s=a-e.position.x,c=o-e.position.z;e.position.set(a,1.8+Math.sin(t*.9*n+r)*.4,o),Math.abs(s)+Math.abs(c)>1e-4&&(e.rotation.y=Math.atan2(-c,s))}),c.forEach(t=>{t.value+=e*n})},t},wrasse(e){let t=e.length??4,n=new J,r=null,i=null,a=null;new zu().load(`/models/meshy-wrasse.glb`,e=>{let o=e.scene;o.updateMatrixWorld(!0);let s=new X().setFromObject(o).getSize(new W);o.scale.setScalar(t/Math.max(s.x,s.y,s.z)),o.traverse(e=>{e.isMesh&&(e.geometry.computeVertexNormals(),e.material=new Ba({map:e.material.map??null,side:2}),e.frustumCulled=!1)});let c=Yd(o,{freq:2.3,waveLen:5.6,ampRatio:.13,pivot:.16,twist:.22});o.rotation.y=Math.PI/2,o.updateMatrixWorld(!0);let l=new X().setFromObject(o).getCenter(new W);o.position.sub(l),n.add(o),r=c.uTime,i=c.uAmpScale,a=c.uBend});let o=1;return n.userData.animate=(e,t,n)=>{r&&(r.value+=e*n*o)},n.userData.setSwimDrive=(e,t)=>{o=e,i&&(i.value=t)},n.userData.setSwimBend=e=>{a&&(a.value=e)},n},puffer(e){let t=e.size??3,n=new J,r=null,i=null;new zu().load(`/models/meshy-puffer.glb`,a=>{let o=a.scene;o.updateMatrixWorld(!0);let s=new X().setFromObject(o).getSize(new W);o.scale.setScalar(t/Math.max(s.x,s.y,s.z)),o.traverse(e=>{e.isMesh&&(e.geometry.computeVertexNormals(),e.material=new Ba({map:e.material.map??null,side:2}),e.frustumCulled=!1)});let c=Yd(o,{freq:2,waveLen:4,ampRatio:.055,pivot:.05,twist:.07}),l=new X().setFromObject(o),u=l.getCenter(new W),d=l.getSize(new W),f=1/o.scale.x,p=Math.max(d.x,d.y)/2*.92*f,m=d.z*f,h=new Ba({color:14264370,emissive:4140556}),g=new W(0,1,0),_=new W,v=e.spikes??16;for(let e=0;e<v;e++){let t=1-2*(e+.5)/v,n=Math.sqrt(1-t*t),r=e*2.39996;_.set(n*Math.cos(r),t,n*Math.sin(r));let i=new hi(new wa(m*.035,m*.3,5),h);i.position.copy(_).multiplyScalar(p),i.position.z=i.position.z*.75+u.z*f,i.position.y+=u.y*f,i.quaternion.setFromUnitVectors(g,_),i.frustumCulled=!1,o.add(i)}o.rotation.y=Math.PI/2,o.updateMatrixWorld(!0);let y=new X().setFromObject(o).getCenter(new W);o.position.sub(y),n.add(o),r=c.uTime,i=c.uAmpScale});let a=1;return n.userData.animate=(e,t,n)=>{r&&(r.value+=e*n*a)},n.userData.setSwimDrive=(e,t)=>{a=e,i&&(i.value=t)},n},schoolYellow(e){let t=new J,n=[[0,0,0],[-1.3,.5,.8],[-1.3,-.45,-.75],[-2.4,.85,-.5],[-2.4,-.7,.55]],r=[],i=[],a=[];for(let i=0;i<(e.count??5);i++){let e=new J;e.position.set(...n[i%n.length]),t.add(e),r.push(e)}t.userData.schoolMembers=r,new zu().load(`/models/meshy-tang.glb`,e=>{let t=e.scene;t.updateMatrixWorld(!0);let n=new X().setFromObject(t).getSize(new W);t.scale.setScalar(1.7/Math.max(n.x,n.y,n.z)),t.traverse(e=>{e.isMesh&&(e.geometry.computeVertexNormals(),e.material=new Ba({map:e.material.map??null,side:2}),e.frustumCulled=!1)}),t.rotation.y=Math.PI/2,t.updateMatrixWorld(!0);let o=new X().setFromObject(t).getCenter(new W);t.position.sub(o),r.forEach((e,n)=>{let r=t.clone(!0),o=Yd(r,{freq:2.6,waveLen:5.4,ampRatio:.11,pivot:.14,twist:.18});o.uTime.value=n*1.7,i.push(o.uTime),a.push(o.uAmpScale),e.add(r)})});let o=1;return t.userData.animate=(e,t,n)=>{i.forEach(t=>{t.value+=e*n*o})},t.userData.setSwimDrive=(e,t)=>{o=e,a.forEach(e=>{e.value=t})},t},schoolSardine(e){let t=new J,n=[],r=[],i=[];for(let r=0;r<(e.count??5);r++){let e=new J;e.position.set(-r*1.5,0,0),t.add(e),n.push(e)}t.userData.schoolMembers=n,new zu().load(`/models/meshy-sardine.glb`,e=>{let t=e.scene;t.updateMatrixWorld(!0);let a=new X().setFromObject(t).getSize(new W);t.scale.setScalar(1.4/Math.max(a.x,a.y,a.z)),t.traverse(e=>{e.isMesh&&(e.geometry.computeVertexNormals(),e.material=new Ba({map:e.material.map??null,side:2}),e.frustumCulled=!1)}),t.rotation.y=Math.PI/2,t.updateMatrixWorld(!0);let o=new X().setFromObject(t).getCenter(new W);t.position.sub(o),n.forEach((e,n)=>{let a=t.clone(!0),o=Yd(a,{freq:3,waveLen:5.8,ampRatio:.13,pivot:.17,twist:.2});o.uTime.value=-n*.9,r.push(o.uTime),i.push(o.uAmpScale),e.add(a)})});let a=1;return t.userData.animate=(e,t,n)=>{r.forEach(t=>{t.value+=e*n*a})},t.userData.setSwimDrive=(e,t)=>{a=e,i.forEach(e=>{e.value=t})},t},octopus(e){let t=e.length??4.31,n=new J,r=null,i=null,a=null;new zu().load(`/models/meshy-octopus.glb`,e=>{let o=e.scene;o.updateMatrixWorld(!0);let s=new X().setFromObject(o).getSize(new W);o.scale.setScalar(t/Math.max(s.x,s.y,s.z)),o.traverse(e=>{e.isMesh&&(e.geometry.computeVertexNormals(),e.material=new Ba({map:e.material.map??null,side:2}),e.frustumCulled=!1)});let c=Yd(o,{freq:1.8,waveLen:3.2,ampRatio:.16,pivot:.06,twist:.18});o.rotation.y=Math.PI/2,o.updateMatrixWorld(!0);let l=new X().setFromObject(o).getCenter(new W);o.position.sub(l),n.add(o),r=c.uTime,i=c.uAmpScale,a=c.uBend});let o=1;return n.userData.animate=(e,t,n)=>{r&&(r.value+=e*n*o)},n.userData.setSwimDrive=(e,t)=>{o=e,i&&(i.value=t)},n.userData.setSwimBend=e=>{a&&(a.value=e)},n},seaTurtle(e){let t=e.length??2.44,n=new J,r=null,i=null;new zu().load(`/models/meshy-turtle.glb`,e=>{let a=e.scene;a.updateMatrixWorld(!0);let o=new X().setFromObject(a).getSize(new W);a.scale.setScalar(t/Math.max(o.x,o.y,o.z)),a.traverse(e=>{e.isMesh&&(e.geometry.computeVertexNormals(),e.material=new Ba({map:e.material.map??null,side:2}),e.frustumCulled=!1)});let s=Jd(a,{freq:1.6,ampRatio:.12,phaseK:1.2,power:2.5});a.rotation.y=Math.PI/2,a.updateMatrixWorld(!0);let c=new X().setFromObject(a).getCenter(new W);a.position.sub(c),n.add(a),r=a,i=s.uTime});let a=1,o=0;return n.userData.animate=(e,t,n)=>{r&&(o+=e*n*a,r.rotation.z=Math.sin(o*.9)*.07,r.rotation.x=Math.sin(o*.6+1.2)*.05,i&&(i.value+=e*n*a))},n.userData.setSwimDrive=e=>{a=e},n},coralColony(e){let t=new Y(ff(e.colorA)),n=new Y(ff(e.colorB)),r=e.branches??15,i=e.labels??[];return lf({h:7,spread:1.9,yaw:.9,topAlign:!0,glowCount:5,onModel:(e,a)=>{let o=cf(a,e);for(let e=0;e<r;e++){let s=new J,c=e*2.39996,l=.15+.7*Math.sqrt(e/r);s.rotation.set(Math.cos(c)*l,0,Math.sin(c)*l);let u=t.clone().lerp(n,e/(r-1)),d=new Ba({color:u,emissive:1575444});Kd.register(d,{dayColor:1575444,nightColor:u.clone().multiplyScalar(.6)});let f=2.6+e%4*.55,p=new hi(new Ca(.14,.24,f,6),d);p.position.y=f/2,s.add(p),[-.5,.55].forEach(e=>{let t=new hi(new Ca(.07,.13,f*.45,5),d);t.position.y=f*.45/2;let n=new J;n.position.y=f*.92,n.rotation.z=e,n.add(t),s.add(n)});let m=new hi(new Da(.16,6,5),new Ba({color:u.clone().lerp(new Y(16777215),.35),emissive:u,emissiveIntensity:.25}));Kd.register(m.material,{base:.25,boost:1.6}),m.position.y=f+.05,s.add(m);let h=Qd(u.clone().lerp(new Y(16777215),.3),1.3,.85);h.position.y=f+.05,s.add(h),s.userData.label=i[e]??``;let g=Math.sqrt(e/r)*2.8;s.position.copy(o(Math.cos(c)*g,Math.sin(c)*g)),s.position.y-=.15,a.add(s)}}})},reefPearls(e){let t=e.pearls??18,n=new Ba({color:ff(e.pearl),emissive:9082016,emissiveIntensity:.35});Kd.register(n,{base:.35,boost:1.1,dayColor:9082016,nightColor:11194608});let r=lf({h:6,spread:1.75,yaw:3.6,topAlign:!0,glowCount:4,onModel:(e,r)=>{let i=sf(r,e,{h:6,spread:1.75,topAlign:!0});for(let e=0;e<t;e++){let t=e*2.39996,a=i(t,.35+.6*(e*.618%1)),o=new hi(new Da(.24,8,6),n);a?o.position.copy(a).setY(a.y+.08):o.position.set(Math.cos(t)*1.5,-.2,Math.sin(t)*1.5),r.add(o);let s=Qd(13624575,.85,.42);s.position.copy(o.position),r.add(s)}}});return r.userData.count=t,r},kelp3(e){let t=new Y(ff(e.color)),n=new Y(ff(e.tipGlow)),r=[],i=[.4,2.5,4.6],a=lf({h:6,spread:1.6,yaw:5.1,topAlign:!0,glowCount:4,onModel:(a,o)=>{let s=cf(o,a);for(let a=0;a<(e.clumps??3);a++){let c=Math.cos(i[a])*1.9,l=Math.sin(i[a])*1.9;for(let i=0;i<5;i++){let u=7+i%3*2.4,d=Pu(u),f=d.attributes.position,p=new Float32Array(f.count*3),m=new Y;for(let e=0;e<f.count;e++){let r=f.getY(e)/u;m.copy(t).lerp(n,r**1.6),p[e*3]=m.r,p[e*3+1]=m.g,p[e*3+2]=m.b}d.setAttribute(`color`,new fr(p,3));let h=new hi(d,new Ba({vertexColors:!0,side:2,emissive:ff(e.tipGlow),emissiveIntensity:.22}));Kd.register(h.material,{base:.22,boost:1.2}),h.scale.x=.7+i%3*.2,h.position.copy(s(c+(i-2)*.45,l+i*.7%1.4-.7)),h.position.y-=.1,h.rotation.y=i*1.2+a,h.userData.ph=i*1.9+a*2.3,o.add(h),r.push(h)}}}});return a.userData.animate=(e,t,n)=>{r.forEach(e=>{e.rotation.z=Math.sin(t*.8*n+e.userData.ph)*.16})},a},vitaReef(e){let t=lf({h:e.height??26,glowCount:e.glowCount??24});return t.userData.setVitality=e=>rf.setVitality(e),t.userData.setNight=e=>rf.setNight(e),t},silhouette(e){let t=e.length??6,n=new ri({color:ff(e.color),transparent:!0,opacity:e.opacity??.55}),r=new J,i=new Ta(Bd.map(e=>new U(Math.max(e[1]*t,.001),e[0]*t)),20);i.rotateX(Math.PI/2),i.translate(0,0,-t/2),r.add(new hi(i,n));let a=Vd({h:t*.14,w:t*.13,lean:.5,color:ff(e.color)});a.material=n,a.position.set(0,t*.11,t*.05),r.add(a);let o=pf(t*.55,ff(e.color));o.children.forEach(e=>{e.material=n}),o.position.z=-t/2+.1,r.add(o),zd(r);let s=new J;return s.add(r),s.userData.animate=(t,r,i)=>{n.opacity=(e.opacity??.55)*(.75+.25*Math.sin(r*.7*i))},s}};function hf({canvas:e,camera:t,targets:n,entities:r,M:i=1}){let a=e=>r.find(t=>t.id===e),o=document.getElementById(`card`),s=document.getElementById(`hint`),c=null,l=6;function u(e){c=e?n.find(t=>t.userData.pick===e):null;let t=e?a(e):null;if(c){let e=new X().setFromObject(c).getSize(new W),n=t?.visual?.length??t?.visual?.span??t?.visual?.focusR??0;l=Math.max(e.x,e.y,e.z,n,2)}if(t){document.getElementById(`cSpecies`).textContent=t.card.species;let e=document.getElementById(`cName`);if(e.textContent=t.name,t.tier){let n=document.createElement(`span`);n.className=`tier `+t.tier.toLowerCase(),n.textContent=t.tier+` 티어`,e.appendChild(n)}document.getElementById(`cWhy`).textContent=t.card.why,document.getElementById(`cDesc`).textContent=t.card.desc,document.getElementById(`btnDetail`).href=`detail.html?id=${t.id}`,o.classList.add(`on`),s.classList.add(`off`)}else o.classList.remove(`on`),s.classList.remove(`off`)}let d=new ss,f=new U;function p(e,r){f.set(e/innerWidth*2-1,-(r/innerHeight)*2+1),d.setFromCamera(f,t);let i=d.intersectObjects(n,!0);for(let e of i){let t=e.object;for(;t&&!t.userData.pick;)t=t.parent;if(t)return t.userData.pick}return null}let m=new W(0,2,-2),h=0,g=!1;try{g=localStorage.getItem(`aq-orbit`)===`1`}catch{}let _=document.getElementById(`btnOrbit`),v=()=>_&&_.classList.toggle(`active`,g);v(),_?.addEventListener(`click`,()=>{g=!g;try{localStorage.setItem(`aq-orbit`,g?`1`:`0`)}catch{}v()});let y=0,b=0,x=!1,S=!1,C=0,w=0,T=0;e.addEventListener(`pointerdown`,t=>{x=!0,S=!1,C=w=t.clientX,T=t.clientY,e.setPointerCapture(t.pointerId)}),e.addEventListener(`pointermove`,t=>{x&&(h-=(t.clientX-C)*.005,C=t.clientX,Math.abs(t.clientX-w)+Math.abs(t.clientY-T)>6&&(S=!0)),y=(t.clientX/innerWidth-.5)*2,b=(t.clientY/innerHeight-.5)*2,x||(e.style.cursor=p(t.clientX,t.clientY)?`pointer`:`default`)}),e.addEventListener(`pointerup`,e=>{x&&(x=!1,S||u(p(e.clientX,e.clientY)))}),e.addEventListener(`pointercancel`,()=>{x=!1}),document.getElementById(`btnBack`).addEventListener(`click`,()=>u(null)),addEventListener(`keydown`,e=>{e.key===`Escape`&&u(null)});let E=new W(0,5,42),D=m.clone();t.position.copy(E);let O=new W,k=new W,A=!1;function ee(e,n){if(c){let e=l;O.copy(c.position).add(new W(e*.25,e*.22,e*1.15+3.5)),k.copy(c.position).add(new W(0,e*.1,0)),A&&=(E.copy(O),D.copy(k),!1)}else g&&!x&&(h+=e*.03),O.set(Math.sin(h)*42+y*2.5,5-b*1.5,Math.cos(h)*42+m.z),k.copy(m);E.lerp(O,Math.min(1,e*2.6)),D.lerp(k,Math.min(1,e*2.6)),t.position.copy(E),t.lookAt(D)}let te=new URLSearchParams(location.search);te.has(`az`)&&(h=+te.get(`az`)||0,E.set(Math.sin(h)*42,5,Math.cos(h)*42+m.z));let j=te.get(`focus`);return j&&a(j)&&(te.has(`snap`)?(u(j),A=!0):setTimeout(()=>u(j),1800)),{update:ee,setFocus:u}}var gf={default:{label:`현행`,day:Au,night:ju},dawn:{label:`새벽 안개`,day:{...Au,waterTop:5930953,waterMid:2770836,waterBot:1056594,fog:4477342},night:{...ju,waterTop:2894176,waterMid:1380920,waterBot:460052,fog:1841221}}};function _f(e){let t=e.getHours()+e.getMinutes()/60;return .5-.5*Math.cos(2*Math.PI*t/24)}var vf=[`waterTop`,`waterMid`,`waterBot`,`fog`,`sand`,`particle`,`hemi`,`sun`,`mesaRock`,`mesaCap`,`ridge`],yf=[`fogDensity`,`hemiIntensity`,`sunIntensity`,`rayOpacity`,`sparkleOpacity`,`coralGlow`,`jelly`,`moteOpacity`,`poolIntensity`,`fillIntensity`];function bf(e,t,n){let r={};for(let i of vf)r[i]=new Y(e[i]).lerp(new Y(t[i]),n).getHex();for(let i of yf)r[i]=e[i]+(t[i]-e[i])*n;return r}function xf(e,t,n){e.setTokens(bf(t.night,t.day,n))}var Sf=0,Cf=-2;function wf(e,t){return Math.sin(e*.53+t*3.1)*.55+Math.sin(e*1.27+t*7.7)*.3+Math.sin(e*2.41+t*1.9)*.15}function Tf(e){return 7.5-4*Math.min(1,Math.max(0,(e+10)/26))}function Ef(e,t){let n=t-e;for(;n>Math.PI;)n-=Math.PI*2;for(;n<-Math.PI;)n+=Math.PI*2;return n}function Df(e,t,n,r){let i=t.phase??0,a=wf(r,i)*(t.turn??1),o=e.x-Sf,s=e.z-Cf,c=Math.hypot(o,s)||1e-5,l=Math.atan2(-s,o),u=Math.max(t.rMin,Tf(e.y)+1.5);c>t.rMax?a+=Ef(e.yaw,l+Math.PI)*(.8+(c-t.rMax)*.5):c<u&&(a+=Ef(e.yaw,l)*(1+(u-c)*.7));let d=(t.turn??1)*2.5+.6;e.steer=Math.max(-d,Math.min(d,a)),e.yaw+=e.steer*n,e.speed=t.speed*(1+.35*wf(r*.6+40,i+11)),e.x+=Math.cos(e.yaw)*e.speed*n,e.z+=-Math.sin(e.yaw)*e.speed*n;let f=(t.yMin+t.yMax)/2,p=(t.yMax-t.yMin)/2;e.y=f+wf(r*.35+80,i+23)*p}function Of(e){let t=(e.phase??0)*2.4,n=(e.rMin+e.rMax)/2;return{x:Sf+Math.cos(t)*n,z:Cf-Math.sin(t)*n,y:(e.yMin+e.yMax)/2,yaw:t+Math.PI/2,speed:e.speed,steer:0}}function kf(e){let t=Of(e),n=e.bobAmp??.3,r=e.bobFreq??.5,i=e.phase??0,a=0,o=0,s=null;function c(t){s||!t?.length||(s=t.map((t,n)=>({h:t,pos:t.position.clone(),vel:new W(Math.cos(n*2.4),0,Math.sin(n*2.4)).multiplyScalar((e.school.mSpeed??1)*.5),bank:0,prevYaw:null,sf:.85+.3*((Math.sin((n+1)*12.9898)*43758.5453%1+1)%1),nSeed:i+n*5.7})))}let l=new W,u=new W,d=new W;function f(t,n,r,i,a){let o=e.school,c=s.length,f=s.reduce((e,t)=>e+t.pos.x,0)/c,p=s.reduce((e,t)=>e+t.pos.y,0)/c,m=s.reduce((e,t)=>e+t.pos.z,0)/c,h=s.reduce((e,t)=>e+t.vel.x,0)/c,g=s.reduce((e,t)=>e+t.vel.y,0)/c,_=s.reduce((e,t)=>e+t.vel.z,0)/c;for(let e of s){l.set(0,0,0),l.x+=(f-e.pos.x-e.pos.x*.6)*(o.cohesion??1),l.y+=(p-e.pos.y-e.pos.y*.6)*(o.cohesion??1),l.z+=(m-e.pos.z-e.pos.z*.6)*(o.cohesion??1),l.x+=(h-e.vel.x)*(o.align??1),l.y+=(g-e.vel.y)*(o.align??1),l.z+=(_-e.vel.z)*(o.align??1);for(let t of s){if(t===e)continue;u.subVectors(e.pos,t.pos);let n=u.length();n<(o.sep??.9)&&n>1e-5&&l.addScaledVector(u.normalize(),((o.sep??.9)-n)*6)}l.x+=wf(a*.9+3,e.nSeed)*.8,l.y+=wf(a*.8+9,e.nSeed+3)*.4,l.z+=wf(a*1.1+17,e.nSeed+7)*.8;let c=e.pos.length();c>o.radius&&l.addScaledVector(u.copy(e.pos).normalize(),-(c-o.radius)*4),e.vel.addScaledVector(l,i);let v=e.vel.length(),y=(o.mSpeed??1)*e.sf*(1+.25*wf(a*.7,e.nSeed+31));if(v>y*1.6&&e.vel.multiplyScalar(y*1.6/v),v<y*.4&&v>1e-5&&e.vel.multiplyScalar(y*.4/v),e.pos.addScaledVector(e.vel,i),e.h.position.copy(e.pos),d.set(t+e.vel.x,n+e.vel.y,r+e.vel.z),d.lengthSq()>1e-6){e.h.rotation.order=`YXZ`;let t=Math.atan2(-d.z,d.x);if(e.prevYaw!==null&&i>1e-6){let n=Ef(e.prevYaw,t),r=Math.max(-.3,Math.min(.3,-(n/i)*.12));e.bank+=(r-e.bank)*Math.min(1,i*4)}e.prevYaw=t,e.h.rotation.y=t,e.h.rotation.x=e.bank;let n=Math.hypot(d.x,d.z);e.h.rotation.z=Math.max(-.4,Math.min(.4,Math.atan2(d.y,n)*.5))}}}return{state:t,update(l,u,d,p){let m=Math.min(u,.05)*d,h=p*d,g=t.x,_=t.y,v=t.z;Df(t,e,m,h);let y=m>1e-6?(t.x-g)/m:0,b=m>1e-6?(t.y-_)/m:0,x=m>1e-6?(t.z-v)/m:0;if(l.position.set(t.x,t.y+Math.sin(h*r+i)*n,t.z),e.school)c(l.userData.schoolMembers),s&&f(y,b,x,m,h);else{l.rotation.order=`YXZ`,l.rotation.y=t.yaw,a+=(Math.max(-.35,Math.min(.35,-t.steer*.25))-a)*Math.min(1,u*3),l.rotation.x=a;let e=Math.max(-.3,Math.min(.3,Math.atan2(b,Math.max(Math.hypot(y,x),.1))*.5));o+=(e-o)*Math.min(1,u*2.5),l.rotation.z=o,l.userData.setSwimBend?.(a*1.4)}let S=t.speed/e.speed;l.userData.setSwimDrive?.(.55+.5*S,.75+.3*S)}}}var Af={recent:[{date:`2026-08-27`,commits:12}]},jf=`modulepreload`,Mf=function(e){return`/`+e},Nf={},Pf=function(e,t,n){let r=Promise.resolve();if(t&&t.length>0){let e=document.getElementsByTagName(`link`),i=document.querySelector(`meta[property=csp-nonce]`),a=i?.nonce||i?.getAttribute(`nonce`);function o(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:`fulfilled`,value:e}),e=>({status:`rejected`,reason:e}))))}function s(e){return import.meta.resolve?import.meta.resolve(e):new URL(e,import.meta.url).href}r=o(t.map(t=>{if(t=Mf(t,n),t=s(t),t in Nf)return;Nf[t]=!0;let r=t.endsWith(`.css`);for(let n=e.length-1;n>=0;n--){let i=e[n];if(i.href===t&&(!r||i.rel===`stylesheet`))return}let i=document.createElement(`link`);if(i.rel=r?`stylesheet`:jf,r||(i.as=`script`),i.crossOrigin=``,i.href=t,a&&i.setAttribute(`nonce`,a),document.head.appendChild(i),r)return new Promise((e,n)=>{i.addEventListener(`load`,e),i.addEventListener(`error`,()=>n(Error(`Unable to preload CSS for ${t}`)))})}))}function i(e){let t=new Event(`vite:preloadError`,{cancelable:!0});if(t.payload=e,window.dispatchEvent(t),!t.defaultPrevented)throw e}return r.then(t=>{for(let e of t||[])e.status===`rejected`&&i(e.reason);return e().catch(i)})},Ff=ku(document.getElementById(`sea`)),If=Fu(Ff.scene,Au,Ff.M),Lf=df();Ff.scene.add(Lf);var Rf=[],zf=[];for(let t of e()){let e=mf[t.visual.builder];if(!e)continue;let n=e(t.visual);if(n.userData.pick=t.id,t.lane&&n.userData.selfDriven)n.position.set((t.lane.minX+t.lane.maxX)/2,t.lane.y-1.8,t.lane.z);else if(t.wander){let e=kf(t.wander);Rf.push((t,r)=>e.update(n,t,Ff.M,r))}else t.visual.position&&n.position.set(...t.visual.position);if(n.userData.animate&&Rf.push((e,t)=>n.userData.animate(e,t,Ff.M)),n.userData.setVitality){let e=Af.recent?.at(-1)?.commits??0;n.userData.setVitality(Math.min(1,e/20))}Ff.scene.add(n),zf.push(n)}var Bf=new URLSearchParams(location.search),Vf=Bf.get(`hour`);function Hf(){let e=new Date;return Vf!==null&&e.setHours(+Vf,0,0,0),e}var Uf=Bf.get(`palette`);if(gf[Uf]||(Uf=null),!Uf)try{let e=localStorage.getItem(`aq-palette`);gf[e]&&(Uf=e)}catch{}function Wf(){return gf[Uf??`default`]}var Gf=Bf.get(`phase`);if(Gf!==`day`&&Gf!==`night`&&(Gf=null),!Gf)try{let e=localStorage.getItem(`aq-phase`);(e===`day`||e===`night`)&&(Gf=e)}catch{}function Kf(){return Gf===`day`?1:Gf===`night`?0:_f(Hf())}var qf=Kf(),Jf=!0;function Yf(){xf(If,Wf(),qf);for(let e of zf)e.userData.setNight?.(1-qf);Lf.userData.setNight?.(1-qf),Kd.setNight(1-qf)}function Xf(){Bf.has(`tune`)||(Jf=!0,document.querySelectorAll(`.hud .chip[data-phase]`).forEach(e=>e.classList.toggle(`active`,e.dataset.phase===Gf)),document.querySelectorAll(`.hud .chip[data-palette]`).forEach(e=>e.classList.toggle(`active`,e.dataset.palette===Uf)))}{let e=document.getElementById(`hud`),t={day:`낮`,night:`밤`};for(let n of Object.keys(t)){let r=document.createElement(`button`);r.className=`chip`,r.dataset.phase=n,r.textContent=t[n],r.addEventListener(`click`,()=>{Gf=Gf===n?null:n;try{Gf?localStorage.setItem(`aq-phase`,Gf):localStorage.removeItem(`aq-phase`)}catch{}Xf()}),e.appendChild(r)}let n=document.createElement(`button`);n.className=`chip`,n.dataset.palette=`dawn`,n.textContent=`새벽`,n.addEventListener(`click`,()=>{Uf=Uf===`dawn`?null:`dawn`;try{Uf?localStorage.setItem(`aq-palette`,Uf):localStorage.removeItem(`aq-palette`)}catch{}Xf()}),e.appendChild(n)}Bf.has(`tune`)?Pf(()=>import(`./tune-DSFEU1VU.js`).then(e=>e.setupTuner(If)),[]):(Xf(),Ff.onFrame(e=>{let t=Kf()-qf;Math.abs(t)>4e-4&&(qf=Math.abs(t)<.01?Kf():qf+t*Math.min(1,e*2.2),Jf=!0),Jf&&=(Yf(),!1)}));var Zf=hf({canvas:document.getElementById(`sea`),camera:Ff.camera,targets:zf,entities:e(),M:Ff.M});if(Ff.onFrame((e,t)=>{If.animate(e,t);for(let n of Rf)n(e,t);Zf.update(e,t)}),Bf.has(`dbg`)){let e=0;addEventListener(`error`,e=>{document.title=`ERR `+e.message}),Ff.onFrame((t,n)=>{e++,document.title.startsWith(`ERR`)||(document.title=`cam ${Ff.camera.position.x.toFixed(2)},${Ff.camera.position.y.toFixed(2)},${Ff.camera.position.z.toFixed(2)} t=${n.toFixed(1)} f=${e} M=${Ff.M}`)})}Ff.start();export{Au as n,ju as t};